...
select_sql="select * from LoRa where `timestamp`= %s and `sensor`='D'"
cursor.execute(select_sql,date)
result=cursor.fetchall()
conn.commit()
d = 'D'
if result==():
	insert_sql="insert into LoRa values('{}',{},{},{},{},'{}','{}')".format(d,temp,hum,PM25,PM10,date,nid)
