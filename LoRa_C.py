...
select_sql="select * from LoRa where `timestamp`= %s and `sensor`='C'"
cursor.execute(select_sql,date)
result=cursor.fetchall()
conn.commit()
c = 'C'
if result==():
	insert_sql="insert into LoRa values('{}',{},{},{},{},'{}','{}')".format(c,temp,hum,PM25,PM10,date,nid)
